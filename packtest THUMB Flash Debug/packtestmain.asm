	...
	.thumb
	.syntax unified
	.file	"packtestmain.cpp"
	.text
.Ltext0:
	.section	.text._Z13packdataCountv,"axG",%progbits,_Z13packdataCountv,comdat
	.align	2
	.weak	_Z13packdataCountv
	.thumb
	.thumb_func
	.type	_Z13packdataCountv, %function
_Z13packdataCountv:
.LFB0:
	.file 1 "/d/work/dro/packdatatest.h"
	.loc 1 22 0
...
.L3:
	...
	.word	packdataBegin
.LFE0:
	.size	_Z13packdataCountv, .-_Z13packdataCountv
	.section	.text.wtf,"ax",%progbits
	.align	2
	.global	wtf
	.thumb
	.thumb_func
...
wtf:
.LFB1:
	.file 2 "/d/work/dro/packtestmain.cpp"
	.loc 2 4 0
...
.L9:
	...
	bcs	.L8
.LBB3:
	.loc 2 12 0 is_stmt 1 discriminator 2
	ldr	r3, [r7, #12]
	ldrb	r3, [r3]
	strb	r3, [r7, #3]
.LBE3:
...
.Ldebug_macro1:
	...
	.4byte	.LASF391
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.packdatatest.h.2.fcb5ba08ed0c3a46cf359c9d38ee871a,comdat
.Ldebug_macro2:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF403:
	.ascii	"/d/work/dro/packtestmain.cpp\000"
.LASF67:
...
.LASF393:
	.ascii	"PACKMEMBERTAG(prior) __attribute((section(\".rodata"
	.ascii	".packdata.\" #prior )))\000"
.LASF381:
	.ascii	"__ELF__ 1\000"
.LASF396:
	.ascii	"bool\000"
...
.LASF394:
	.ascii	"PACKMEMBER PACKMEMBERTAG(5)\000"
.LASF366:
