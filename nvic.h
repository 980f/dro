...
struct Irq {
  /** used to access hardware bits, should probably const and cache group and mask */
  u8 number;
  ...
  void uncrustWierdness(void){} //just in this file sa uncrust.exe was improperly formatting the last function.
};
